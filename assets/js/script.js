document.addEventListener('DOMContentLoaded', (event) => {
	...
	let qCount = 0;
	let timeset;
	let answers = document.querySelectorAll('#questions button');
	...
	let setQuestionData = () => {
		queryElement('#questions p').innerHTML = questions[qCount].title;
		queryElement('#questions button:nth-of-type(1)').innerHTML = `1. ${questions[qCount].choices[0]}`;
		queryElement('#questions button:nth-of-type(2)').innerHTML = `2. ${questions[qCount].choices[1]}`;
		queryElement('#questions button:nth-of-type(3)').innerHTML = `3. ${questions[qCount].choices[2]}`;
		queryElement('#questions button:nth-of-type(4)').innerHTML = `4. ${questions[qCount].choices[3]}`;
    }
